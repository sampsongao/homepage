    ...
    <div className="bg-white dark:bg-black">
      <div className="" style={{
        backgroundImage: `
            ...
            radial-gradient(circle at 24% 1200px, rgb(76 94 255 / 25%) 0px, rgb(0 0 0 / 0%) 500px),
        ...
        <section>
          <div className="container py-16 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <section className="container py-16 my-20">
              ...
              >
                ...
                <div className="col-span-1">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent mt-2 text-gray-800 dark:text-gray-200 px-2 border border-solid p-1 border-zinc-400 rounded-md"
                  />
                </div>
                <div className="col-span-1">
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[100px] bg-transparent mt-2 text-gray-800 dark:text-gray-200 px-2 border border-solid p-1 border-zinc-400 rounded-md"
                  />
                </div>
